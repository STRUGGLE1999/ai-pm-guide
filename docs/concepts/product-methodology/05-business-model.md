...
## 10. AI 产品增长：首次成功任务比注册更重要

AI 产品仍可用获客—激活—留存—付费—转介绍，但每一层有新问题。激活的关键不是注册完成，而是用户第一次获得可信、可用的结果，即「首次成功任务」。售后助手的首次成功，是用户带着真实订单问完「能不能换」，得到带依据的结论，而不是看完欢迎语。

常见手段：模板和案例降低输入门槛、免费额度让用户验证价值、结果分享带来自传播、与既有工作流集成减少迁移成本。留存不能依赖新鲜感，要让产品在重复任务中积累知识、配置、协作关系或历史结果。

增长指标必须连上价值指标：写作看合格产物与采纳；客服看一次解决和满意度；销售看有效线索、跟进和成交贡献。对话数、Token 数和生成次数只是使用量，不天然代表价值。

### 定价单位靠近客户感知的价值

常见定价包括免费、订阅、席位、按量、分层、项目制、结果付费和混合。企业知识助手可以按席位加用量，文档处理可以按页或任务，复杂交付可能包含实施费。

价值定价的上限来自客户获得的增量收益和替代成本；成本决定价格下限；竞品和预算习惯影响可接受区间。免费额度应足以完成一次价值验证，又不让高成本用户长期占用资源。

核心单位经济仍是 CAC、付费转化、ARPU、毛利率、续费率、流失率、LTV 和回收周期。AI 还要跟踪单位任务模型成本、人工服务成本和重度用户成本分布，避免「收入增长、毛利恶化」。评测与公式见 [模型评估与质量](/concepts/model-evaluation)。

### 商业策略要向上追问真实目标

不能只接收「提高转化」。要问：是增长收入、提高毛利、进入新客群、建立渠道、降低风险，还是改善现金流。不同目标会导向完全不同的产品动作。

指标应形成因果链：战略目标 → 业务指标 → 用户行为 → 产品能力 → 模型指标。提高客服续费不能只优化回答准确率，还可能需要缩短解决时间、识别高风险客户、改善转人工和闭环工单。

北极星指标要同时体现用户获得的价值与业务可持续性。短期付费转化不能以误导、强制续费或降低回答质量为代价。

ROI 情景至少做保守 / 基准 / 乐观三列：覆盖用户、月均任务、采纳率、单任务收益、模型与工具成本、人工审核成本、月均净收益、回收周期。采纳率砍半或审核减不下来时，项目是否仍成立，要在立项时写明。

## 11. 一人公司：杠杆在流程，不在「AI 员工数」

本质不是一个人完成所有工作，而是创始人用 AI、自动化、标准化产品与外包网络放大杠杆。适合的机会通常是市场不必很大，但需求足够深、回款路径短、客户愿意为明确结果付费。

闭环：发现已验证但未充分满足的需求 → 获得精准流量 → 产品或服务交付 → 成交与收款 → 复购和转介绍 → 把重复工作沉淀为流程、数据和可复用能力。先卖服务常能快速理解问题，再把稳定部分产品化。

主要风险：客户过度集中、创始人成为所有流程瓶颈、平台流量依赖、定制吞噬毛利、数据和版权不清。判断是否可扩张，不看「AI 员工数量」，看每新增一位客户需要增加多少人工时间。

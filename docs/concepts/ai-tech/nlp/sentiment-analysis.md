...
情感分析是判断文本表达的态度或情绪，例如正面、中性、负面，或者愤怒、焦虑、满意、失望。它常用于评论分析、客服质检、舆情监控和用户反馈挖掘。
...
| 正负向分类 | 快速判断整体口碑。 |
| 情绪识别 | 客服安抚、投诉预警。 |
| 方面级情感 | 判断用户对价格、物流、质量分别怎么看。 |
| 强度评分 | 区分轻微不满和强烈投诉。 |

## 读者要注意

情感分析很容易被讽刺、反问、行业黑话和上下文影响。比如“真是太智能了，连我的订单都找不到”，字面有正面词，但真实情绪是负面。
...
2.1 情感分析 可以拆成输入、处理、输出和指标四层。这样读的时候不会停留在概念名，而是能看到它在系统里接收什么、改变什么、产出什么。

...
无监督学习没有标准答案，模型要从数据中自己发现结构。吴恩达课程里的这部分适合帮助读者理解聚类、降维、异常检测和探索性分析。

<figure class="article-figure">
  <img src="/concepts/ai-tech/01-infographic-ai-pm-map.png" alt="无监督学习地图">
  <figcaption>无监督学习适合先探索数据结构，再决定是否能形成可执行产品策略。</figcaption>
</figure>

## 技术视角

无监督学习常用于用户分群、问题聚类、内容主题整理、异常发现。它的结果不天然等于业务结论，需要业务解释和验证。

| 方法 | 用途 | 需要追问 |
| --- | --- | --- |
| 聚类 | 找相似群组。 | 每一类是否有业务含义？ |
| 降维 | 可视化和压缩特征。 | 是否帮助发现问题？ |
| 异常检测 | 找离群样本。 | 漏报和误报代价是什么？ |

<figure class="article-figure">
  <img src="/concepts/ai-tech/05-flowchart-ai-quality-loop.png" alt="无监督学习质量闭环">
  <figcaption>无监督学习结果要经过业务解释、人工抽样和后续行动验证。</figcaption>
</figure>

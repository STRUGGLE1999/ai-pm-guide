...
机器学习基础帮助你判断一个 AI 需求是否能被数据驱动解决。它不是算法背诵，而是需求、数据、标签、指标和错误代价之间的技术判断。
...
2. [监督学习](/concepts/ai-tech/ml/supervised-learning)
3. [无监督学习](/concepts/ai-tech/ml/unsupervised-learning)
4. [推荐系统](/concepts/ai-tech/ml/recommendation-systems)
5. [时间序列与预测](/concepts/ai-tech/ml/time-series-forecasting)
6. [强化学习](/concepts/ai-tech/ml/reinforcement-learning)
7. [机器学习十大算法](/concepts/ai-tech/ml/classic-algorithms)
8. [概率统计基础](/concepts/ai-tech/ml/probability-statistics)
9. [线性代数与微积分](/concepts/ai-tech/ml/linear-algebra-calculus)

学完这一组，你应该能回答：这个任务要预测什么、用什么数据、怎么评估、什么错误不能接受，以及推荐、预测、策略优化这类常见 AI 系统该怎样拆成数据和指标问题。
...
机器学习基础导读 可以拆成输入、处理、输出和指标四层。这样读的时候不会停留在概念名，而是能看到它在系统里接收什么、改变什么、产出什么。
